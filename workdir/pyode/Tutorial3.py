...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 29 22:11:47 2020
...
# floor = ode.GeomCapsule(space, radius=0.5, length=1.0)
...
# idle callback
def _idlefunc ():
    global counter, state, lasttime, totalcounter
    ...
    filename = "{0}/img{1:05d}.png".format('png', totalcounter)
